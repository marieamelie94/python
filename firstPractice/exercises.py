...
def studentAwards(studentGrades):
  ...
  sorted_by_grades = sorted(studentGrades.items(), key=operator.itemgetter(1))
  print("The top 3 students are:")
  print("{} with a grade of {}, winning 500$".format(sorted_by_grades[-1][0],sorted_by_grades[-1][1]))
  print("{} with a grade of {}, winning 300$".format(sorted_by_grades[-2][0],sorted_by_grades[-2][1]))
  print("{} with a grade of {}, winning 100$".format(sorted_by_grades[-3][0],sorted_by_grades[-3][1]))
